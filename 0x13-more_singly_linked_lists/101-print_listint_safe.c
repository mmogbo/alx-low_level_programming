 ...
 *on the list
 * @head: A pointer that points to the head of the list to check.
 *
 * Return: conditional 0 if not looped else number of
 * unique nodes on the list.
 */
size_t looped_listint_len(const listint_t *head)
{
 ...
 *
 * Return: total number of nodes on the list.
 */
size_t print_listint_safe(const listint_t *head)
{
